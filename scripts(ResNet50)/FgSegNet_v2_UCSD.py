...
from FgSegNet_v2_Resnet import FgSegNet_v2_module
...
def train(data, scene, mdl_path, resnet50_weights_path):
    ...
    model = FgSegNet_v2_module(lr, img_shape, scene, resnet50_weights_path)
...
if not os.path.exists(resnet50_weights_path):
    WEIGHTS_PATH_NO_TOP = 'https://github.com/fchollet/deep-learning-models/releases/download/v0.1/resnet50_weights_tf_dim_ordering_tf_kernels_notop.h5'
    resnet50_weights_path = get_file('resnet50_weights_tf_dim_ordering_tf_kernels_notop.h5',
...
for scene in dataset:
    ...
    train(results, scene, mdl_path, resnet50_weights_path)
    del results
